            ...
            put("/UpdatePrice", (req, res) -> {
                try{
                    ...
                    try {
                        ...
                        halt(400, "{messgae: Bad Request - JSON object must have a field named 'distributor', distributor may not exist in the object, also check your type of the value it must be integer}");
                     ...
                     try {
                        ...
                        System.out.println("Error parsing JSON: " + e.getMessage());
                        halt(400, "{messgae: Bad Request - JSON object must have a field named 'item', item may not exist in the object,  also check your type of the value it must be integer}");
                    ...
                    try {
                        ...
                        System.out.println("Error parsing JSON: " + e.getMessage());
                        halt(400, "{messgae: Bad Request - JSON object must have a field named 'cost', cost may not exist in the object, also check your type of the value it must be double}");
                   ...
                   if(array.size() == 0){
                         halt(400, "{messgae: Bad Request - distributor doesn't exist in distributor database}");
                   }
